...
namespace Mtf.Cryptography.AsymmetricCiphers
{
    ...
    public class RsaCipher : IAsymmetricCipher, IDisposable
    {
        ...
        public RsaCipher(string keyFilePath, bool includePrivateParameters = false, bool useOaepPadding = true)
            : this(RsaKeyLoader.LoadRsaParametersFromXml(keyFilePath, includePrivateParameters), useOaepPadding)
        {
        }
        ...
        public RsaCipher(RSAParameters parameters, bool useOaepPadding = true)
        {
            ...
            PublicKeyParameters = parameters.ToPublicKey();
